...
const fetchContributorStats = async (username: string) => {
  const apiUrl = `https://askexe.com/api/contributors/contributorStats/${username}`;
...
const fetchContributorImage = async (username: string) => {
  const apiUrl = `https://askexe.com/api/contributors/${username}/og.png`;
...
const runCongratulate = async () => {
  ...
  const contributorUrl = `https://askexe.com/contributors/${userName}`;
  ...
  const message =
    ...
    `![Contributions](https://askexe.com/api/contributors/${userName}/og.png)`;
