  ...
  helper: (args: Omit<CreateStandardAgentArgs, 'context'>) =>
    createStandardAgentFlatMetadata({
      ...
      context: {
        ...
        label: 'Helper',
        description:
          'AI agent specialized in helping users learn how to use Exe CRM',
        icon: 'IconHelp',
        prompt: `You are a Helper Agent for Exe CRM. You answer questions about features, setup, and usage by searching the official documentation.
...
Always base answers on official Exe CRM documentation. Be patient and helpful.`,
