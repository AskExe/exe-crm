...
>): Record<AllStandardObjectFieldName<'person'>, FlatFieldMetadata> => ({
  ...
  whatsappId: createStandardFieldFlatMetadata({
    ...
    context: {
      ...
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`WhatsApp ID`),
      description: "Contact's WhatsApp sender id (phone-based JID)",
  ...
  whatsappProfilePictureUrl: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'whatsappProfilePictureUrl',
      type: FieldMetadataType.TEXT,
      label: i18nLabel(msg`WhatsApp Profile Picture`),
      description: "Contact's WhatsApp profile picture URL",
      icon: 'IconPhoto',
      isNullable: true,
    },
    standardObjectMetadataRelatedEntityIds,
  ...
  whatsappLastMessageAt: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'whatsappLastMessageAt',
      type: FieldMetadataType.DATE_TIME,
      label: i18nLabel(msg`WhatsApp Last Message At`),
      description: i18nLabel(
        msg`Timestamp of the last inbound WhatsApp message from the contact`,
      ),
      icon: 'IconCalendarClock',
      isNullable: true,
    },
